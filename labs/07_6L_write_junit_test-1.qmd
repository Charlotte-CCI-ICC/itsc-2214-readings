...
Please go through the the [writing JUnit tests chapter](../05_writing_junit_tests.md), [mutation testing chapter](../06_mutation_testing.md), the [List of Mutators chapter](../07_list_of_mutators.md), and the slides on Mutation Testing from the lecture.
